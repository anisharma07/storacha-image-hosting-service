...
This directory contains comprehensive tests generated by Claude AI for the storacha-image-hosting-service project.
...
- `FileInputField.test.tsx` - Application tests
- `Progress.test.tsx` - Application tests
- `ServiceCard.test.tsx` - Service layer tests
- `CatCard.test.tsx` - Application tests
- `SignInButton.test.tsx` - Application tests
- `use-toast.test.ts` - Application tests
- `upload-toast.test.tsx` - Application tests
- `gateway.test.ts` - Application tests
- `auth.test.ts` - Application tests
- `file-upload-flow.test.tsx` - Application tests
- `test-setup.ts` - Application tests
